...
def executaBatalha(maquina1, maquina2):
    ...
    while True:
        ...
        proximoEstadoJogador1 = obterAtualEstadoJogador(jogador1, numerosTransicao, leitura)
        mensagemVidaJogador1 = f"{jogador1.vidaAtual}"

        jogador2.valorAtributoJogador = random.randint(1, 10)
        proximoEstadoJogador2 = obterAtualEstadoJogador(jogador2, numerosTransicao, leitura)
